...
final class Version20250718130211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, user_messages_id INT DEFAULT NULL, public_chatbot_id INT DEFAULT NULL, personal_chatbot_id INT DEFAULT NULL, message LONGTEXT DEFAULT NULL, response LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_DB021E96C8B96CF (user_messages_id), INDEX IDX_DB021E966D97254F (public_chatbot_id), INDEX IDX_DB021E9659546220 (personal_chatbot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE personal_chatbot (id INT AUTO_INCREMENT NOT NULL, api_key VARCHAR(255) NOT NULL, assistant VARCHAR(255) NOT NULL, instructions LONGTEXT DEFAULT NULL, model VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
